...
<!--  <el-table
     ...
     <el-table-column align="center" label="操作" width="250" fixed="right">
        <template slot-scope="scope">
          ...
          <router-link style=" margin-right:10px" :to="{path:'/admin/newstype/add',query:{id:scope.row.id}}"><el-button type="danger" size="mini" icon="el-icon-edit">编辑</el-button></router-link>
...
<script>
import {GetList,Del} from "@/api/newstype";
export default {
       data() {
        return {
          tableData: [],
