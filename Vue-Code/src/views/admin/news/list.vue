...
<!--  <el-table
      ...
      <el-table-column prop="title" label="资讯名称"></el-table-column>
      <el-table-column prop="newstype.type" label="资讯类型"></el-table-column>
     ...
     <el-table-column align="center" label="操作" width="350" fixed="right">
        <template slot-scope="scope">
          <router-link style=" margin-right:10px" :to="{path:'/admin/news/add',query:{id:scope.row.id}}"><el-button type="danger" size="mini" icon="el-icon-edit">编辑</el-button></router-link>
...
<script>
import {GetList,Del} from "@/api/news";
